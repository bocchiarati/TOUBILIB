...
#### GET /praticiens/{id_prat}/rdvs => obtenir les rendez-vous d'un praticien (QueryParams : date_debut, date_fin)
...
#### GET /patient/{id_pat}/rdvs => obtenir les rendez-vous d'un patient (QueryParams : date_debut, date_fin)